  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contributor as @contributor" do
        ...
        post :create, {:contributor => { "last" => "invalid value" }}, valid_session
        assigns(:contributor).should be_a_new(Contributor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contributor" do
        ...
        Contributor.any_instance.should_receive(:update_attributes).with({ "last" => "MyString" })
        put :update, {:id => contributor.to_param, :contributor => { "last" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contributor as @contributor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contributor.any_instance.stub(:save).and_return(false)
        put :update, {:id => contributor.to_param, :contributor => { "last" => "invalid value" }}, valid_session
        assigns(:contributor).should eq(contributor)
      end
