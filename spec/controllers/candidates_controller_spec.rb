  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved candidate as @candidate" do
        ...
        post :create, {:candidate => { "elected" => "invalid value" }}, valid_session
        assigns(:candidate).should be_a_new(Candidate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested candidate" do
        ...
        Candidate.any_instance.should_receive(:update_attributes).with({ "elected" => "false" })
        put :update, {:id => candidate.to_param, :candidate => { "elected" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the candidate as @candidate" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Candidate.any_instance.stub(:save).and_return(false)
        put :update, {:id => candidate.to_param, :candidate => { "elected" => "invalid value" }}, valid_session
        assigns(:candidate).should eq(candidate)
      end
